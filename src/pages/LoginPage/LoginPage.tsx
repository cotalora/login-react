...
import { ButtonSocial, CarouselCards, FormLogin } from "./components";
                    ...
                    <Box className="login-container">
                        ...
                        <Box className="info-container">
                            <Box className="data-text-container">
                                <Typography variant="h1" className="title-data-text">
                                    KURISU WEB
                                </Typography>
                                <Box className="subtitle-paragraph-data-text-container">
                                    <Typography variant="h2" className="subtitle-data-text">
                                        Realiza tus proyectos con nosotros.
                                    </Typography>
                                    <Typography paragraph={true} className="paragraph-data-text">
                                        Descubre el mundo de la mejor comunidad de freelancers y
                                        empresarios.
                                    </Typography>
                                </Box>
                            </Box>
                        ...
                        <Box className="form-container">
                            ...
                            <Typography className="form-text" variant="body2">
